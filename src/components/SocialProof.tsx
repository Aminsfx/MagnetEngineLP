...
const SocialProof: React.FC = () => {
  return (
    <section className="py-20 border-t border-white/5 bg-surface">
      <div className="max-w-4xl mx-auto px-6 text-center">
        <h2 className="text-sm font-semibold tracking-widest text-neutral-500 uppercase mb-10">Trusted by coaches & agencies scaling to $50k/mo</h2>
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-neutral-400">
